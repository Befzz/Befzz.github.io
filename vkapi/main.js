...
addEventListener('load', function() {
    ...
    vklogin.addEventListener('click',function(event){
        ...
        var win = window_popup("https://oauth.vk.com/authorize?client_id=3915837&display=popup&redirect_uri=http://h.meokay.ru/reg/&scope=friends,offline,wall,status,notify,photos&response_type=code&v=5.35","VK auth")
    });
